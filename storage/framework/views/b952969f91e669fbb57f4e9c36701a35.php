        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(url('employees')); ?>" class="nav-link">Employee List</a></li>
                </ul>
                <hr class="d-lg-none text-white-50">
...
</html<?php /**PATH E:\1.perkuliahan\semester 6\PEMROGRAMAN FRAMEWORK\Minggu 5\PrakModul4Laravel\resources\views/home.blade.php ENDPATH**/ ?>