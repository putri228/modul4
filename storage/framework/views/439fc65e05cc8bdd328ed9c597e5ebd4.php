...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a href="<?php echo e(url('employees')); ?>" class="navbar-brand mb-0 h1"><i class="bi-hexagon-fill me-2"></i> Data Master</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-6 col-md-auto"><a href="<?php echo e(url('employees')); ?>" class="nav-link">Employee List</a></li>
                </ul>
                <hr class="d-lg-none text-white-50">
...
</html><?php /**PATH E:\1.perkuliahan\semester 6\PEMROGRAMAN FRAMEWORK\Minggu 5\PrakModul4Laravel\resources\views/profile.blade.php ENDPATH**/ ?>